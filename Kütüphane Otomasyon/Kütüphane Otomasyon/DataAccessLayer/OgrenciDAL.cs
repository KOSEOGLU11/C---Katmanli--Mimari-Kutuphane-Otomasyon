...
//sing Entity;           // Entity katmanını kullandık.
...
namespace DAL
{
    public class OgrenciDAL
    {
        ...
        public static bool ogrenciKontrol(Ogrenci ogr)
        {
        ...
        public static bool OgrenciOkulNoKontrol(Ogrenci ogrenci)
        {
        ...
        public static int ogrenciIdSorgu(Ogrenci ogr)
        {
        ...
        public static bool ogrenciSorgu(Ogrenci ogr)
        {
        ...
        public static int ogrenciSil(Ogrenci ogrenci)
        {
        ...
        public static Ogrenci ogrenciIdBilgi(Ogrenci ogrenci)
        {
            OleDbCommand command = new OleDbCommand("Select * from Ogrenci where OgrenciId = @OgrenciId", Baglanti.baglanti);
            Baglanti.Connection(command);
            command.Parameters.AddWithValue("@OgrenciId", ogrenci.OgrenciId);
